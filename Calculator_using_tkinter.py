...
def asin():
    ...
    expression = float(expression)
    if inverted:
        expression = round(math.asin(expression), 5)
    else:
        expression = round(math.sin(math.radians(expression)), 5)
    equation.set(float(expression))
    expression = str(expression)
...
def acos():
    ...
    expression = float(expression)
    if inverted:
        expression = round(math.acos(expression), 5)
    else:
        expression = round(math.cos(math.radians(expression)), 5)
    equation.set(float(expression))
    expression = str(expression)
...
def atan():
    ...
    expression = float(expression)
    if inverted:
        expression = round(math.atan(expression), 5)
    else:
        expression = round(math.tan(math.radians(expression)), 5)
    equation.set(float(expression))
    expression = str(expression)
...
def inv():
    ...
    if inverted:
        sin.configure(text='sin^-1')
        cos.configure(text='cos^-1')
        tan.configure(text='tan^-1')
    else:
...
if __name__ == "__main__":
    ...
    equation.set('Insert your expression here')
    ...
    buttonab = Button(gui, text=' √(A^2 + B^2) ', fg='white', bg='black',
    command=lambda: retrieve_input(), height=1,width=11)
    buttonab.grid(row=15, column=0, sticky=W + E)

    button1 = Button(gui, text=' 1 ', fg='grey', bg='blue',
    command=lambda: press(1), height=1, width=7)
    button1.grid(row=4, column=0)

    button2 = Button(gui, text=' 2 ', fg='grey', bg='blue',
    command=lambda: press(2), height=1, width=7)
    button2.grid(row=4, column=1)

    button3 = Button(gui, text=' 3 ', fg='grey', bg='blue',
    command=lambda: press(3), height=1, width=7)
    button3.grid(row=4, column=2)

    button4 = Button(gui, text=' 4 ', fg='grey', bg='blue',
    command=lambda: press(4), height=1, width=7)
    button4.grid(row=3, column=0)

    button5 = Button(gui, text=' 5 ', fg='grey', bg='blue',
    command=lambda: press(5), height=1, width=7)
    button5.grid(row=3, column=1)

    button6 = Button(gui, text=' 6 ', fg='grey', bg='blue',
    command=lambda: press(6), height=1, width=7)
    button6.grid(row=3, column=2)

    button7 = Button(gui, text=' 7 ', fg='grey', bg='blue',
    command=lambda: press(7), height=1, width=7)
    button7.grid(row=2, column=0)

    button8 = Button(gui, text=' 8 ', fg='grey', bg='blue',
    command=lambda: press(8), height=1, width=7)
    button8.grid(row=2, column=1)

    button9 = Button(gui, text=' 9 ', fg='grey', bg='blue',
    command=lambda: press(9), height=1, width=7)
    button9.grid(row=2, column=2)

    button0 = Button(gui, text=' 0 ', fg='grey', bg='blue',
    command=lambda: press(0), height=1, width=7)
    button0.grid(row=5, column=1)

    plus = Button(gui, text=' + ', fg='azure', bg='coral',
    command=lambda: press("+"), height=1, width=7)
    plus.grid(row=2, column=3)

    minus = Button(gui, text=' - ', fg='azure', bg='coral',
    command=lambda:press("-"), height=1, width=7)
    minus.grid(row=3, column=3)

    multiply = Button(gui, text=' * ', fg='azure', bg='coral',
    command=lambda: press("*"), height=1, width=7)
    multiply.grid(row=4, column=3)

    divide = Button(gui, text=' / ', fg='azure', bg='coral',
    command=lambda: press("/"), height=1, width=7)
    divide.grid(row=5, column=3)

    equal = Button(gui, text=' = ', fg='azure', bg='coral',
    ...
    sqrt = Button(gui, text=' √ ', fg='black', bg='white', command=sqrt,
    height=1, width=7)
    sqrt.grid(row=3, column=6)

    dec = Button(gui, text=' . ', fg='black', bg='light green', command=lambda:
    press("."), height=1, width=7)
    dec.grid(row=5, column=4)
